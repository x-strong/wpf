...
public class FloatValueTrigger : DataTrigger
{
    ...
    public new float Value
    {
        ...
        set
        {
            ...
            if (IsSealed)
            {
                throw new InvalidOperationException(SR.Format(SR.CannotChangeAfterSealed, nameof(FloatValueTrigger)));
            }
    ...
    protected internal override void Seal()
    {
        ...
        TriggerConditions =
        [
            new FloatValueTriggerCondition(
                _binding,
                Relation,
                _value)
        ];
